...
export class MainComComponent {
  ...
  l_img_url:string="assets/image/L_paper.jpg";
  r_img_url:string="assets/image/R_paper.jpg";
...
pap_win(){
        ...
        this.l_img_url="assets/image/L_paper.jpg";
        this.r_img_url="assets/image/R_rock.jpg";
}
pap_draw(){
        ...
        this.h_draw=this.h_draw+1;
         this.l_img_url="assets/image/L_paper.jpg";
        this.r_img_url="assets/image/R_paper.jpg";
}
pap_loss(){
        this.t_match=this.t_match+1;
        ...
        this.l_img_url="assets/image/L_paper.jpg";
        this.r_img_url="assets/image/R_sci.jpg";
}
rock_win(){
        ...
        this.h_win=this.h_win+2;
        this.m_lost=this.m_lost+1;
        this.l_img_url="assets/image/L_rock.jpg";
        this.r_img_url="assets/image/R_sci.jpg";
}
rock_draw(){
        this.t_match=this.t_match+1;
...
sci_win(){
        ...
        this.h_win=this.h_win+2;
        this.m_lost=this.m_lost+1;
        this.l_img_url="assets/image/L_sci.jpg";
        this.r_img_url="assets/image/R_paper.jpg";
